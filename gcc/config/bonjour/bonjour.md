...
(define_mode_iterator BONJOURIM [QI HI SI])
...
(define_insn "push_for_prologue"
  ...
  "reload_completed"
  {
    return bonjour_prepare_push_pop_string (0);
  }
  [(set_attr "length" "4")]
)
...
(define_insn "pop_and_popret_return"
  ...
  "reload_completed"
  {
    return bonjour_prepare_push_pop_string (1);
  }
  [(set_attr "length" "4")]
)
...
(define_insn "<plusminus_insn>di3"
  ...
  ""
  {
    return bonjour_emit_add_sub_di (operands, <plusminus_flag>);
  })
...
(define_insn "<any_logic_insn>di3"
  ...
  ""
  {
    return bonjour_emit_logical_di (operands, <any_logic_flag>);
  })
...
(define_insn "one_cmpl<mode>2"
  [(set (match_operand:BONJOURIM 0 "register_operand" "=r")
	(not:BONJOURIM (match_operand:BONJOURIM 1 "register_operand" "0")))]
  ""
  "xor<tIsa>\t$-1, %0"
  [(set_attr "length" "2")]
)
...
(define_expand "ashr<mode>3"
  [(set (match_operand:BONJOURIM 0 "register_operand" "")
	(ashiftrt:BONJOURIM (match_operand:BONJOURIM 1 "register_operand" "")
...
(define_expand "lshr<mode>3"
  [(set (match_operand:BONJOURIM 0 "register_operand" "")
	(lshiftrt:BONJOURIM (match_operand:BONJOURIM 1 "register_operand" "")
...
;; All sorts of move are nor supported by BONJOUR. Therefore, 
	...
	if (!register_operand (operands[0], <MODE>mode))
	  {
		...
		to be pushed is SP as BONJOUR does not support pushing SP.  */
		...
		if (!register_operand (operands[1], <MODE>mode))
		  {
		    /* BONJOUR does not support moving immediate to SI or SF 
		       type memory.  */
		    if (<MODE>mode == SImode || <MODE>mode == SFmode ||
			<MODE>mode == DImode || <MODE>mode == DFmode)
		      operands[1] = copy_to_mode_reg (<MODE>mode, operands[1]);
		    else
		      /* moving imm4 is supported by BONJOUR instruction.  */
...
(define_insn "cbranch<mode>4"
  [(set (pc)
	(if_then_else (match_operator 0 "ordered_comparison_operator"
		      [(match_operand:BONJOURIM 1 "register_operand" "r,r")
		       (match_operand:BONJOURIM 2 "nonmemory_operand" "r,n")])
...
(define_expand "cmp<mode>"
  [(parallel [(set (cc0)
    (compare (match_operand:BONJOURIM 0 "register_operand" "")
	     (match_operand:BONJOURIM 1 "nonmemory_operand" "")))
...
(define_expand "cstore<mode>4"
  [(set (cc0)
	(compare (match_operand:BONJOURIM 2 "register_operand" "")
		 (match_operand:BONJOURIM 3 "nonmemory_operand" "")))
...
(define_insn "*cmp<mode>_insn"
  [(set (cc0)
	(compare (match_operand:BONJOURIM 0 "register_operand" "r,r")
		 (match_operand:BONJOURIM 1 "nonmemory_operand" "r,n")))]
  ""
  "cmp<tIsa>\t%1, %0"
  [(set_attr "length" "2,4")]
)
...
(define_expand "call"
  ...
  ""
  {
	...
	emit_call_insn (gen_bonjour_call (operands[0], operands[1]));
      }
    else
      emit_call_insn (gen_bonjour_call (operands[0], operands[1]));
      DONE;
...
(define_insn "bonjour_call_insn_branch_pic"
...
(define_insn "bonjour_call_insn_branch"
  [(call (mem:QI (match_operand:SI 0 "call_imm_operand" "i"))
	 (match_operand 1 "" ""))
   (clobber (match_operand:SI 2 "register_operand" "+r"))]
...
(define_insn "bonjour_call_insn_jump"
...
(define_expand "call_value"
  ...
  ""
  {
	...
	emit_call_insn (gen_bonjour_call_value (operands[0], operands[1], operands[2]));
      }
    else
	emit_call_insn (gen_bonjour_call_value (operands[0], operands[1], operands[2]));
    DONE;
...
(define_expand "bonjour_call_value"
  [(parallel
    [(set (match_operand 0 "general_operand" "")
...
(define_insn "bonjour_call_value_insn_branch_pic"
...
(define_insn "bonjour_call_value_insn_branch"
  [(set (match_operand 0 "" "=g")
	(call (mem:QI (match_operand:SI 1 "call_imm_operand" "i"))
	      (match_operand 2 "" "")))
   (clobber (match_operand:SI 3 "register_operand" "+r"))]
...
(define_insn "bonjour_call_value_insn_jump"
  [(set (match_operand 0 "" "=g")
